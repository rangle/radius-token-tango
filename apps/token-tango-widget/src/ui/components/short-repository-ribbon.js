...
export const StatusButton = ({ color, icon, children }) => (<AutoLayout name="Button" fill="#00B012" cornerRadius={9233.1904296875} strokeWidth={0.923} overflow="visible" spacing={4} padding={{
        top: 3.694,
        right: 12,
        bottom: 3.694,
        left: 6,
    }} height={22} horizontalAlignItems="end" verticalAlignItems="center">
    <Icon16px name="StatusIcon" width={14.775} height={14.775} icon={icon} color="#fff"/>
    {children}
  </AutoLayout>);
export const SmallRepositoryRibbon = ({ name, status, error, ...props }) => {
    const { icon, color } = statusChoices[status];
    return (<AutoLayout name="SmallRepositoryRibbon" fill="#333" stroke="#484848" cornerRadius={8} direction="vertical" spacing={"auto"} padding={8} horizontalAlignItems="center" {...props}>
      <AutoLayout name="RepositoryHeader" overflow="visible" spacing="auto" width={"hug-contents"} minWidth={270} verticalAlignItems="center">
        <AutoLayout name="RepositoryHeader" overflow="visible" width={"fill-parent"} spacing={"auto"} verticalAlignItems="center">
          <AutoLayout name="RepositoryTitle" overflow="visible" spacing={8} verticalAlignItems="center">
            <SVG name="Vector" height={22} width={22} src="<svg width='23' height='23' viewBox='0 0 23 23' fill='none' xmlns='http://www.w3.org/2000/svg'>
  ...
  "/>
            <AutoLayout name="TextHeader" overflow="visible" spacing={8} verticalAlignItems="center">
              <Text name="Repository:" fill="#DADADA" verticalAlignText="center" fontFamily="Roboto Mono" fontSize={12}>
                Repository:
              </Text>
              <Text name="Frontend-monorepo" fill="#DADADA" verticalAlignText="center" fontFamily="Roboto Mono" fontSize={12}>
                {name}
              </Text>
            </AutoLayout>
          </AutoLayout>
